...
//
                    if ("\(person["verify_Profile_id"]!)") == "0" {
                        let alert = UIAlertController(title: "Alert", message: "Please wait for admin approval to add and sell product in pet store.", preferredStyle: UIAlertController.Style.alert)
