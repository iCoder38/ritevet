        ...
        if let person = UserDefaults.standard.value(forKey: "keyLoginFullData") as? [String:Any] {
            ...
            //if let person = UserDefaults.standard.value(forKey: "saveVeterinarianRegistration") as? [String:Any] {
                   parameters = [
                       ...
                       "userId"             :   String(myString),
                       "UTYPE"              :   "3",
                       "VBusinessAddress"   :   String(self.txtStreetAddress.text!),
                       "VBSuite"            :   String(self.txtSuit.text!),
                       "countryId"          :   String(self.strCountryId),
                       "countryName"        :   String(self.txtCountry.text!),
                       "VState"             :   String(self.txtState.text!),
                       "stateId"            :   String(self.strStateId),
                       "Vcity"              :   String(self.txtCity.text!),
                       "VZipcode"           :   String(self.txtZipcode.text!),
                       "VEmail"             :   String(self.txtEmail.text!),
                       "typeOfBusiness"     :   String(addAllStrings),
                       "MessageChat"        :   String(self.saveChatFunc),
                       "videoChat"          :   String(self.saveVideoFunc),
                       "AudioChat"          :   String(self.saveAudioFunc),
